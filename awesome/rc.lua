...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "一", "二", "三", "四", "五" }, s, layouts[2])
end
-- }}}
...
vicious.register(memwidget, vicious.widgets.mem, "RAM <span color='#E6264B'>$2MB</span> | ", 5)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "z", function () awful.util.spawn("anki -b /home/merono/.anki") end),
    awful.key({ modkey }, "v", function () awful.util.spawn("/home/merono/./.vmstart") end),
    awful.key({ modkey }, "d", function () awful.util.spawn("gnome-terminal -e ranger") end),
...
-- autostart programs
awful.util.spawn_with_shell("/home/merono/./.startup.sh")
